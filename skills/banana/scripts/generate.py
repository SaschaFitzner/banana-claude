...
def generate_image(prompt, model, aspect_ratio, resolution, api_key,
                   thinking_level=None, image_only=False, output_dir=None):
...
def main():
    ...
    parser.add_argument("--output-dir", default=None, help="Output directory for generated images (default: ./<nanobanana_generated> in CWD)")
